...
const validateUser = {
  ...
  signup: [
    check('password')
      ...
      .withMessage('Password should not be empty: input password')
      .trim()
      .isLength({ min: 7 })
    ...
    check('firstName')
      .not()
      .isEmpty({ ignore_whitespace: true })
      .withMessage('First Name should not be left empty: input firstName')
      .isAlpha()
      .trim()
      .withMessage('first Name can only contain letters: remove invalid characters')
      .customSanitizer(value => value.toLowerCase()),
    check('lastName')
      .not()
      .isEmpty({ ignore_whitespace: true })
      .withMessage('Last name should not be left empty: input lastName')
      .isAlpha()
      .trim()
